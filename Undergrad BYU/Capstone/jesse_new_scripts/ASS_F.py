...
os.system( error_c % (taxaname+"_tmp/corrected/",R1,R2,threads))
#os.system( Ucat % (taxaname+"_tmp/corrected/corrected/*.gz",taxaname+"_tmp/BOTH.fq" ))

#S4 usearch mapping 1 fullprobeset
print("\n\nUsearch mapping......\n\n")
#os.system( Us % (taxaname+"_tmp/BOTH.fq", fullprobeset, taxaname+"_tmp/MAP1"))
#os.system( Ufilter % (taxaname+"_tmp/MAP1",taxaname+"_tmp/mreads"))


#S5 get ontarget reads
#print("\n\nCollecting mapped reads\n\n")
#os.system(getread % (taxaname+"_tmp/mreads", taxaname+"_tmp/corrected/corrected/"+prout1+".00.0_0.cor.fastq.gz", taxaname+"_tmp/sub_"+rout1))
